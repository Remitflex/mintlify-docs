...
| `GET` | `/v1/webhooks/{webhookEndpointId}` | `webhooks:read` |
| `PATCH` | `/v1/webhooks/{webhookEndpointId}` | `webhooks:write` |
| `POST` | `/v1/webhooks/{webhookEndpointId}/rotate-secret` | `webhooks:write` |
| `DELETE` | `/v1/webhooks/{webhookEndpointId}` | `webhooks:write` (soft revoke) |
| `GET` | `/v1/webhooks/{webhookEndpointId}/deliveries` | `webhooks:read` |
| `POST` | `/v1/webhooks/{webhookEndpointId}/test` | `webhooks:write` |
