...
On `completed`, `refunded`, and `failed`, Remitflex emails a receipt to the payer (when an email was collected), the linked customer, and the creating dashboard user.
