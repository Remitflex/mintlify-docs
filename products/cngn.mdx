...
| Need | Endpoint |
|------|----------|
| Live primary Smart Wallet balances | `GET /v1/cngn/customers/{customerId}/wallets` |
...
| Need | Use |
|------|-----|
| Live wallet balances | `GET /v1/cngn/customers/{customerId}/wallets` (or dashboard **Refresh**) — returns the primary Base Smart Wallet with live CNGN/USDC/USDT balances |
