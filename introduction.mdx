...
RemitFlex is stablecoin payment infrastructure for the African market. Think [Bridge](https://bridge.xyz)-style programmable money movement — swaps, collection routes, customer records, and a unified ledger — delivered through a single REST API.

We help businesses accept stablecoins, convert between denominations, and route value across chains without building Solana, Relay, or FX plumbing themselves.

<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/quickstart">
    API key, first rate check, first swap — under ten minutes.
  </Card>
  <Card title="Dashboard" icon="layout-dashboard" href="https://dashboard.kaprex.io">
    Sign up, manage API keys, and monitor activity at dashboard.kaprex.io.
  </Card>
...
| **Payment routes** | Collect on one chain, settle on another (Relay) | `POST /v1/payment-routes` |
...
<Steps>
  <Step title="Create an account">
    Register at [dashboard.kaprex.io](https://dashboard.kaprex.io) and complete email OTP verification.
  </Step>
