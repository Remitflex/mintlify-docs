...
```bash curl
curl -X GET https://api.remitflex.com/v1/rates \
  -H "Authorization: Bearer rmf_test_xxxx"
```

```javascript JavaScript
const res = await fetch("https://api.remitflex.com/v1/rates", {
...
1. Log in at [dashboard.remitflex.com](https://dashboard.remitflex.com).
