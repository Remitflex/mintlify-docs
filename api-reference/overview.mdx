...
The RemitFlex API is a RESTful JSON API for stablecoin swaps, cross-chain payment routes, exchange rates, customers, and a unified transaction ledger.
...
|----------|-------------|
| Rates | Cached FX rates for swap pairs — `GET /rates` |
| Swaps | Same-chain stablecoin swaps — `GET/POST /swaps` |
