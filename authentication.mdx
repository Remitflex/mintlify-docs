...
| Scope | Endpoints |
|-------|-----------|
| `fx:read` | `GET /v1/fiat/rates/...`, `GET /v1/rates`, `GET /v1/rates/{from}/{to}` |
| `transfers:read` | `GET /v1/transactions`, `/v1/customers`, `/v1/swaps`, `/v1/cngn/*` reads |
| `transfers:write` | `POST /v1/customers`, `POST /v1/swaps`, `/v1/cngn/*` writes |
| `collections:read` | `GET /v1/payment-routes`, `GET /v1/collections`, discovery `/chains` |
