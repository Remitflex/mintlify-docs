...
API keys are created in the [RemitFlex Dashboard](https://dashboard.remitflex.com) after you log in. Keys cannot be created via the public API using another API key.
...
<CodeGroup>
  ...
  const response = await fetch("https://api.remitflex.com/v1/rates", {
    headers: {
  ...
  response = requests.get(
      "https://api.remitflex.com/v1/rates",
