...
| `webhooks:read` / `webhooks:write` | List/manage outbound webhook endpoints (`/v1/webhooks`) |
...
Webhook endpoint CRUD (`/v1/webhooks`) accepts **JWT or** API keys with `webhooks:read` / `webhooks:write`. See [Webhooks](/guides/webhooks).
